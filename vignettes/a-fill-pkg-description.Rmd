...
- For r-universe: `Remotes: url::https://thinkr-open.r-universe.dev/src/contrib/fusen_0.4.0.9000.tar.gz`
...
# From r-universe tar.gz
remotes::install_url("https://thinkr-open.r-universe.dev/src/contrib/fusen_0.4.0.9000.tar.gz",
                     quiet = TRUE, upgrade = "never")
attachment::find_remotes("fusen")
```

...
`create_renv_for_dev()` and `create_renv_for_prod()` functions create `renv.lock` files based on developement projects.
...
And thus, run `create_renv_for_dev()` before sending your commit to your remote git server.

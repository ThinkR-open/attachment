...
This outlines how to propose a change to attachment. For more detailed
...
- [roxygen2](https://roxygen2.r-lib.org/): Version \> `7.1.2` is
  required.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ThinkR-open/attachment", fork = TRUE)`.
...
Code of
Conduct](https://github.com/ThinkR-open/attachment/blob/main/CODE_OF_CONDUCT.md).

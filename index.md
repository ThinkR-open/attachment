...
{attachment} detects all calls to
[`library(pkg)`](https://rdrr.io/r/base/library.html),
`@importFrom pkg fun`, `pkg::fun()` in the different classical
directories of your R package, then list them in the correct “Imports”
or “Suggests” category in the DESCRIPTION file, according to their
...
If you run
[`att_amend_desc()`](https://thinkr-open.github.io/attachment/reference/att_amend_desc.md)
a second time afterwards, directly from the console, it will use the
last set of parameters extracted from the configuration file.
...
Function
[`attachment::create_dependencies_file()`](https://thinkr-open.github.io/attachment/reference/create_dependencies_file.md)
will create a `dependencies.R` file in `inst/` directory. This R script
